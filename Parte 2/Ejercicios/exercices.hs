-- Exercises to the second tutorial of "Introducción a la Programación Funcional"
...
dateToStr (Date year month day) = ...

solution2 = putStrLn (dateToStr (Date ... ... ...)
-------------------------------------------------------------------------------------------------------------
{-
